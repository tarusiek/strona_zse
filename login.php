...
<html lang="pl">
    ...
    <body>
        ...
        <h2 id="register_form_h2">Logowanie</h2>
        <div class="auth_content">
            <form action="panel.php" method="post">
                ...
                <button type="submit" name="login_button" class="register_button">Zaloguj</button>

                
                <a href="register.php">Albo się zarejestruj</a>
            </form>
